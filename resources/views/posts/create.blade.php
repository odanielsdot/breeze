                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('posts.store') }}">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required autofocus autocomplete="title">
                        </div>
                        <div>
                            <div>
